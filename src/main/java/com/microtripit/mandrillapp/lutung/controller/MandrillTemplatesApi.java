...
public final class MandrillTemplatesApi {
   ...
   * @param publish Set to false to add a draft template without publishing.
	 ...
	 * @throws IOException
	 */
	public final String render(final String name, final Map<String,String> templateContent,
      final Map<String,String> mergeVars) throws MandrillApiError, IOException {
